package com.example.jejugudgo.domain.user.myGudgo.profile.service;

import com.example.jejugudgo.domain.user.myGudgo.profile.dto.request.UserProfileUpdateRequest;
import com.example.jejugudgo.domain.user.myGudgo.profile.dto.response.UserProfileUpdateResponse;
import com.example.jejugudgo.domain.user.myGudgo.profile.entity.UserProfile;
import com.example.jejugudgo.domain.user.myGudgo.profile.repository.UserProfileRepository;
