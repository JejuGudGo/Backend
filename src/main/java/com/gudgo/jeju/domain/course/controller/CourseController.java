...
public class CourseController {
    ...
    public Page<CourseResponseDto> getCourses(@PathVariable("userId") Long userId, Pageable pageable) {
        return courseService.getMyCourses(userId, pageable);
    }

    @GetMapping(value = "/{userId/courses/{courseId}")
    ...
    @PostMapping(value = "/{userId}/courses")
    ...
    @PostMapping(value = "/{userId}/courses/user/{courseId}")
    ...
    @PostMapping(value = "/{userId}/courses/olle/{courseId}")
    ...
    @PatchMapping(value = "/{userId}/courses/{courseId}")
    public ResponseEntity<?> updateCourse(
            @PathVariable("userId") Long userId,
            @PathVariable("courseId") Long courseId,
            @Valid @RequestBody CourseUpdateRequestDto courseUpdateRequestDto
    ) throws IllegalAccessException {
        courseService.update(userId, courseId, courseUpdateRequestDto);
        return ResponseEntity.ok().build();
    }

    /* DELETE : 코스 삭제
     * DELETE /api/v1/course/user/{courseId}) */
    @DeleteMapping(value = "/{userId}/courses/{courseId}")
